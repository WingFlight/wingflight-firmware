...
static const adjustmentConfig_t adjustmentConfigs[ADJUSTMENT_FUNCTION_COUNT] =
{
    ...
    ADJ_ENTRY(SERVO_TRIM_ROLL,             -SERVO_TRIM_ADJUSTMENT_MAX, SERVO_TRIM_ADJUSTMENT_MAX),
    ADJ_ENTRY(SERVO_TRIM_PITCH,            -SERVO_TRIM_ADJUSTMENT_MAX, SERVO_TRIM_ADJUSTMENT_MAX),
    ADJ_ENTRY(SERVO_TRIM_YAW,              -SERVO_TRIM_ADJUSTMENT_MAX, SERVO_TRIM_ADJUSTMENT_MAX),
