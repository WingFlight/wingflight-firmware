...
// Regression test for #107: a NaN/Inf reaching a servo boundary produced an
// undefined integer written straight to a timer compare register. constrainf()
// and limitf() are the shared clamp helpers used at those boundaries (directly,
