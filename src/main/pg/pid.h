...
typedef struct pidProfile_s {
    ...
    // Oscillation limiter: detects a sustained gain-induced oscillation per axis and ramps
    // master_gain down (never up) for that axis until the next arm/profile reload. See
