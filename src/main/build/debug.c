...
const char * const debugModeNames[DEBUG_COUNT] = {
    ...
    DEBUG_NAME(SBUS),
    DEBUG_NAME(FPORT),
    DEBUG_NAME(UNUSED_25),
    DEBUG_NAME(UNUSED_26),
    DEBUG_NAME(UNUSED_27),
    DEBUG_NAME(ADC_INTERNAL),
    DEBUG_NAME(UNUSED_29),
    DEBUG_NAME(UNUSED_30),
    DEBUG_NAME(CURRENT_SENSOR),
    DEBUG_NAME(USB),
    DEBUG_NAME(UNUSED_33),
    DEBUG_NAME(RTH),
    ...
    DEBUG_NAME(UNUSED_69),
    DEBUG_NAME(UNUSED_70),
    DEBUG_NAME(UNUSED_71),
    DEBUG_NAME(UNUSED_72),
    DEBUG_NAME(UNUSED_73),
    DEBUG_NAME(UNUSED_74),
    DEBUG_NAME(UNUSED_75),
    DEBUG_NAME(UNUSED_76),
    DEBUG_NAME(UNUSED_77),
